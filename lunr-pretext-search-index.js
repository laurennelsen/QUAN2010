...
},
{
  ...
  "number": "7.1.1",
  "title": "",
  "body": " We're going to do a matching activity in class to practice working with these formulas to calculate probabilities for normal distributions. (The next few exercises include online versions of this activity.)  "
},
{
  "id": "matching1",
  "level": "2",
...
},
{
  ...
  "number": "10.1.6",
  "title": "",
  "body": "  A one-tail hypothesis test can be viewed as either a left-tail or right-tail test.  .....insert definition.......   "
},
{
  ...
  "number": "10.1.7",
  "title": "",
  "body": " Look back at the problems mentioned below and decide if each is a one-tail or two-tail test.       one-tail test       two-tail test  "
},
{
...
},
{
  ...
  "number": "10.2.3",
  "title": "",
  "body": " Match each situation with the correct critical value(s). (I recommend drawing a picture of the rejection region to help with this.)     A left-tailed test with            A right-tailed test with        "
},
{
...
},
{
  ...
  "number": "10.2.5",
  "title": "",
  "body": " (Donnelly 9.7)  A pizza place recently hired additional drivers and as a result now claims that its average delivery time for orders is under 46 minutes. A sample of 41 customer deliveries was examined, and the average delivery time was found to be 41.5 minutes. Historically, the standard deviation for delivery time is 11.8 minutes. Assuming that , does this sample provide enough evidence to support the delivery time claim made by the pizza place?   Step 1: Identify the two hypotheses using appropriate notation.       :      : ( left-tail test)      Step 2: Draw the appropriate curve, identify the significance level, and label critical value(s).   Step 3: Calculate the appropriate test statistic.       Step 4: Compare the critical value(s) to the test statistic and make the decision.   Test statistic is left of the critical value so it lands in the rejection region, and we reject  .   Step 5: State the conclusion.   There is enough evidence to support the claim that the average delivery time for orders is under 46 minutes.  "
},
{
  ...
  "number": "10.2.6",
  "title": "",
  "body": " (Donnelly 9.10)  A grocery store claims that customers spend an average of 5 minutes waiting for service at the store's deli counter. A random sample of 40 customers was timed at the deli counter, and the average service time was found to be 5.5 minutes. Assume the standard deviation is 1.7 minutes per customer. Assuming that , does this sample provide enough evidence to counter the claim made by the store's management?   Step 1: Identify the two hypotheses using appropriate notation.       :      : ( two-tail test)      Step 2: Draw the appropriate curve, identify the significance level, and label critical value(s).   Step 3: Calculate the appropriate test statistic.       Step 4: Compare the critical value(s) to the test statistic and make the decision.   The test statistic is between the two critical values so it doesn't land in the rejection region, and we fail to reject  .   Step 5: State the conclusion.   The sample does not provide enough evidence to counter the claim that customers spend an average of 5 minutes waiting for service.  "
},
{
...
},
{
  ...
  "number": "10.4.2",
  "title": "",
  "body": " (Donnelly 9.19)  According to the financial reports by Snapchat, the average daily user of Snapchat created 19 messages, or snaps, per day in Q3 2017. A college student wants to find out if the number of Snapchat messages has changed since Q3 2017 and creates a random sample using information from students on her campus for the current semester. The results are found in this lesson's Excel file. Using , test the hypothesis that the number of Snapchats sent by the average Snapchat user has not changed since Q3 2017. Use the p-value method of hypothesis testing.  !!!INSERT Excel file!!!!!  "
},
{
