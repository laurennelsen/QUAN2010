...
},
{
  ...
  "body": " The Chi-square Distribution    Chi-square Distribution (Made in GeoGebra by Chris Rosenthal)    !!!!!!!!!!Make bullets below multiple choice!!!!!!!!!    The chi-square ( ki square ) distribution, , is similar to the Student's -distribution in that it is a family of curves based on the number of degrees of freedom. The other key properties of the Chi-square distribution:     The distribution curves are not symmetric, but instead are ____________    As the degrees of freedom increases, the skewness ___________    The area under the curve is equal to __________    All values are greater than or equal to ____________        We can use Table 8 in Appendix A of your book to find critical values. The notation for these is .   Find the desired significance level, , across the top of the table.    Locate along the left of the table.     We can also find critical -values using the Excel command    Find the following critical -values:                                   "
},
{
...
},
{
  ...
  "number": "11.1.2",
  "title": "",
  "body": "  The chi-square ( ki square ) distribution, , is similar to the Student's -distribution in that it is a family of curves based on the number of degrees of freedom. The other key properties of the Chi-square distribution:     The distribution curves are not symmetric, but instead are ____________    As the degrees of freedom increases, the skewness ___________    The area under the curve is equal to __________    All values are greater than or equal to ____________      "
},
{
...
},
{
  ...
  "body": " The -Distribution   !!!!!!!!!!make bullets below multiple choice!!!!!!!!!!     The -Distribution is defined as the ratio of variances of two populations normally distributed. It is unique in that it depends on two degrees of freedom: and . The other key properties of the -distribution:   The -distribution curves are not symmetric, but instead ________________    As the degrees of freedom increase, the skewness of the curve __________________    The area under the curve is equal to _________________    All values of the -distribution are greater than or equal to _________________        -Distribution (Made in GeoGebra by therimalaya)    We can use Table 6 in Appendix A of your book to find critical values. The notation for these is .   Find the table with the desired significance level.    Locate across the top of the table.    Locate along the left of the table.     We can also find critical -values using the Excel command    Find the following critical -values:                                   "
},
{
  "id": "def-F-dist",
  "level": "2",
  ...
  "number": "11.3.1",
  "title": "",
  "body": "  The -Distribution is defined as the ratio of variances of two populations normally distributed. It is unique in that it depends on two degrees of freedom: and . The other key properties of the -distribution:   The -distribution curves are not symmetric, but instead ________________    As the degrees of freedom increase, the skewness of the curve __________________    The area under the curve is equal to _________________    All values of the -distribution are greater than or equal to _________________      "
},
{
