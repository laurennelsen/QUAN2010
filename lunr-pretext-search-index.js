...
},
{
  "id": "fillin-integer",
  "level": "2",
  "url": "sec-exponential-distribution.html#fillin-integer",
  "type": "Exercise",
  "number": "5.2.4",
  "title": "Fill-In, Integer Answer.",
  "body": "Fill-In, Integer Answer  The game of bowling uses pins that you try to knock down.      Arranged in a triangle, there are pins, a so-called triangular number.      Close ! You may have used hexadecimal notation, when you did not really mean to.      Incorrect.     "
},
{
  ...
  "number": "5.2.5",
  "title": "",
  "body": " An exponential probability distribution has lambda equal to 18 customers per hour. Find the probability that the next customer will arrive within the next minute. (Round your answer to 4 decimal places.)   .  "
},
{
  "id": "backmatter-2",
  "level": "1",
