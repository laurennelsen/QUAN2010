...
},
{
  ...
  "number": "7.1.1",
  "title": "",
  "body": " We're going to do a matching activity in class to practice working with these formulas to calculate probabilities for normal distributions. (The next few exercises include online versions of this activity.)   Here are the solutions to the in-class activity:   1, L, @    2, I,     3,A,!    4,F,     5,B,     ...need to fix this....      "
},
{
  "id": "matching1",
  "level": "2",
...
{
  "id": "image-normal-matching",
  "level": "2",
  "url": "sec-normal-distribution.html#image-normal-matching",
  "type": "Figure",
  "number": "7.1.16",
  "title": "",
  "body": " Images for    (A)       (B)       (C)       "
},
{
  "id": "ex-NormalImageMatching",
  "level": "2",
  "url": "sec-normal-distribution.html#ex-NormalImageMatching",
  "type": "Exercise",
  "number": "7.1.17",
  "title": "Normal Distribution Matching Problem.",
  "body": "Normal Distribution Matching Problem  Match the images in with the probability that is shown in the image    (a)???   NORM.S.DIST(2.05,1)-NORM.S.DIST(- 0.68,1)     (b)???   1-NORM.DIST(40,135,22,1)     ???   NORM.DIST(90,135,22,1)     ???   Find the probability for a standard normal distribution:     "
},
{
  "id": "matching5",
  "level": "2",
...
{
  "id": "sec-normal-distribution-18",
  "level": "2",
  "url": "sec-normal-distribution.html#sec-normal-distribution-18",
  "type": "Exercise",
  "number": "7.1.20",
  "title": "",
  "body": " Let be the standard normal variable.  Find . Round your answer to four decimal places:         Any value in the interval is marked as correct for this problem.      Incorrect. Did you round to four decimal places?     "
...
},
{
  ...
  "number": "9.5.1",
  "title": "",
  "body": " Binomial and Normal Distributions -value (Made in GeoGebra by Steve Phelps)   "
},
{
...
},
{
  ...
  "number": "10.2.4",
  "title": "",
  "body": " Match each situation with the correct p-value. (I recommend drawing a picture of the rejection region to help with this.)    A left-tailed test with test statistic     A right-tailed test with test statistic     A two-tailed test with test statistic     A two-tailed test with test statistic    "
},
{
...
},
{
  ...
  "number": "10.5.1",
  "title": "",
  "body": " A Harris poll surveyed 2016 adults and found that 463 of them had one or more tattoos. Does the sample provide evidence that the percentage of adults who have a tattoo is less than 25%?    Tattoo Simulation (Made in GeoGebra by Steve Phelps)     "
},
{
...
},
{
  ...
  "body": " The Chi-square Distribution    Chi-square Distribution (Made in GeoGebra by Chris Rosenthal)      The chi-square ( ki square ) distribution, , is similar to the Student's -distribution in that it is a family of curves based on the number of degrees of freedom. The other key properties of the Chi-square distribution:   The distribution curves are not symmetric, but instead are .....    positively skewed      negatively skewed      As the degrees of freedom increases, the skewness .....     decreases      increases      stays the same      The area under the curve is equal to .....     0             1      2      All values are greater than or equal to .....     0      1             2       We can use Table 8 in Appendix A of your book to find critical values. The notation for these is .   Find the desired significance level, , across the top of the table.    Locate along the left of the table.     We can also find critical -values using the Excel command    Find the following critical -values:                                   "
},
{
  ...
  "number": "11.1.1",
  "title": "",
  "body": " Chi-square Distribution (Made in GeoGebra by Chris Rosenthal)   "
},
{
  "id": "def-chi-square",
  "level": "2",
...
},
{
  ...
  "body": " The -Distribution     The -Distribution is defined as the ratio of variances of two populations normally distributed. It is unique in that it depends on two degrees of freedom: and . The other key properties of the -distribution:    The -distribution curves are not symmetric, but instead .....     positively skewed      negatively skewed      As the degrees of freedom increase, the skewness of the curve .....     decreases      increases      stays the same      The area under the curve is equal to .....     1      0      5      All values of the -distribution are greater than or equal to .....     0      1      5      -1       -Distribution (Made in GeoGebra by therimalaya)     We can use Table 6 in Appendix A of your book to find critical values. The notation for these is .   Find the table with the desired significance level.    Locate across the top of the table.    Locate along the left of the table.     We can also find critical -values using the Excel command    Find the following critical -values:                                   "
},
{
  "id": "def-F-dist",
  "level": "2",
...
},
{
  ...
  "number": "11.3.1",
  "title": "",
  "body": " -Distribution (Made in GeoGebra by therimalaya)   "
},
{
  "id": "sec-F-dist-5",
  "level": "2",
